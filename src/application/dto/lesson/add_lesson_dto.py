...
class AddLessonOptions(BaseModel):
    start_date: dateType = Field(description="start date in format YYYY-MM-DD", examples=["2023-01-01", "2023-01-02"])
    end_date: dateType = Field(description="end date in format YYYY-MM-DD", examples=["2023-01-01", "2023-01-02"])
...
class AddLessonDTO(BaseModel):
    ...
    options: AddLessonOptions = Field(default=None)
